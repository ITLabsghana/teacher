...
function InnerLayout({ children }: { children: ReactNode }) {
  ...
  const { currentUser, isLoading, logout, clearLocalData } = useDataContext();
  ...
  const handleLogout = async () => {
    await logout();
    clearLocalData(); // Synchronously clear state
    router.replace('/'); // Redirect after state is cleared
  };
